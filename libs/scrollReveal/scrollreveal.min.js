...
var ScrollReveal = function () {
  ...
  function m(e) {
    ...
    var s, a, c, l, d, u, f, h, p, m, y, v, g, b = parseFloat(t.opacity),
      ...
      E = {computed: b !== w ? "opacity: " + b + ";" : "", generated: b !== w ? "opacity: " + w + ";" : ""}, j = [];
        ...
        n && (e.geometry = x.call(i, e)), e.visible = function (e) {
          ...
          if (t) {
            var n = Math.max(0, Math.min(1, e.config.viewFactor)), i = e.config.viewOffset,
              r = e.geometry.bounds.top + e.geometry.height * n, o = e.geometry.bounds.right - e.geometry.width * n,
              s = e.geometry.bounds.bottom - e.geometry.height * n, a = e.geometry.bounds.left + e.geometry.width * n,
              c = t.geometry.bounds.top + t.scroll.top + i.top, l = t.geometry.bounds.right + t.scroll.left - i.right,
